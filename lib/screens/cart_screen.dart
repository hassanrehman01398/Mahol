...
import 'package:mahool/screens/place_order.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: widget.type == "abc"? IconButton(icon: Icon(Icons.arrow_back,color: primary,), onPressed: (){
          Navigator.pop(context);
        }) :IconButton(icon: Icon(Icons.favorite),color: Colors.white,onPressed: (){},),
        title: Column(
          children: [
            Text("Total",style: TextStyle(color: primary,fontSize: 16),),
            Text("1500 Rs",style: TextStyle(color: primary,fontSize: 16),)
          ],
        ),
        actions: [
          Padding(
          ...
          IconButton(icon: Icon(Icons.recommend,color: Colors.white,), onPressed: (){}),
        ],
      ),
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                        ...
                        trailing: Container(
                          ...
                          child: Row(
                            children: [
                              IconButton(icon: Icon(Icons.add_circle_outlined,color: Colors.green,),),
                              Text("x3",style: TextStyle(color: notifier.darkTheme ? Colors.white :primary,fontSize: 20),),
